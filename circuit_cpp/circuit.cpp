...
void merkle_root_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void merkle_root_2_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 1780;}

uint get_number_of_components() {return 4;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 1329;}
...
merkle_root_2_create(1,0,ctx,"main",0);
merkle_root_2_run(0,ctx);
}
